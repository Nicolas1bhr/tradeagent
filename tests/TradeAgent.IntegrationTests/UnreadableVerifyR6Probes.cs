...
{
    readonly string _dir = Path.Combine(TestEnv.Home, "wit-r6-" + Guid.NewGuid().ToString("n")[..8]);
...
{
    readonly string _dir = Path.Combine(TestEnv.Home, "wit-r6b-" + Guid.NewGuid().ToString("n")[..8]);
