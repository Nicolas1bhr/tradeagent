...
/// <summary>
/// U14 round-6 ADVERSARIAL-VERIFY probes, target 2: the ACCEPTED deviation. For a protocol-mismatched
...
/// </summary>
public class ParkedPeerVerifyR6Probes
{
    static string NewPipe() => "ta-park6-" + Guid.NewGuid().ToString("n")[..12];
