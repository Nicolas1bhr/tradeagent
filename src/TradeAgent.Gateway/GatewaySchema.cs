...
public static class GatewaySchema
{
    ...
    [
        new(Core.Ops.Status,      "trade status",              false,
            ...
            + "24 hours; closing or reducing a position is never "
            ...
            + "A CLOSURE DOES NOT END AT MIDNIGHT. It lasts AT LEAST 24 HOURS from the moment the breach was "
            + "confirmed, and it ends only when TradeAgent itself writes a receipt for it — which it does on its "
