...
2. **`main` is `ce8af23`, clean, pushed.** Landed 2026-09-07/08, in order, each with its section: `U-loss` `7b46503`, `U-seen-1`
...
4. **CI on `main`:** green on all four jobs at every sha from `137aaa4` to `19ef096`; `47d1071` in flight. The eleven
