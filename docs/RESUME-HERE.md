...
2. **`main` is `1757043`, clean, pushed.** Landed 2026-09-07/08, in order, each with its section: `U-loss` `7b46503`, `U-seen-1`
   ...
   **`U-budget-reserve` `1757043`** (no schema change; CI run 34715391501 in flight when this was written).
