...
2. **`main` is `cac1787`, clean, pushed.** Landed 2026-09-07/08, in order, each with its section: `U-loss` `7b46503`, `U-seen-1`
   ...
   **schema 16 on `main`**; CI run 34840620999 in flight when written).
